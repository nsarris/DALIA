...
namespace DataModel.Northwind
{
    ...
    public partial class NorthwndDB : Dalia.Linq2db.LinqToDBDataConnection
    {
        ...
        public ITable<SplitTable1> SplitTable1 { get { return this.GetTable<SplitTable1>(); } }
        ...
        #region FTestCustomers

        [Sql.TableFunction(Schema = "dbo", Name = "FTestCustomers")]
        public ITable<Customer> FTestCustomers(int? @p1)
        {
            return this.GetTable<Customer>(this, (MethodInfo)MethodBase.GetCurrentMethod(),
                @p1);
        }

        #endregion

        #region FTestCustomers2

        [Sql.TableFunction(Schema = "dbo", Name = "FTestCustomers2")]
        public ITable<FTestCustomers2Result> FTestCustomers2(int? @p1)
        {
            return this.GetTable<FTestCustomers2Result>(this, (MethodInfo)MethodBase.GetCurrentMethod(),
                @p1);
        }

        public partial class FTestCustomers2Result
        {
        ...
        private static MethodInfo _freeTextTableMethod1 = typeof(NorthwndDB).GetMethod("FreeTextTable", new Type[] { typeof(string), typeof(string) });
    ...
    [Table(Schema = "dbo", Name = "SplitTable1")]
    public partial class SplitTable1
    {
        [Identity] public int ID { get; set; } // int
        [Column, Nullable] public string Descr1 { get; set; } // varchar(50)
    }
    ...
    public static partial class SqlFunctions
    {
        ...
        [Sql.Function(Name = "dbo.FTestValue", ServerSideOnly = true)]
        public static int? FTestValue(int? @p1)
        {
            throw new InvalidOperationException();
        }
